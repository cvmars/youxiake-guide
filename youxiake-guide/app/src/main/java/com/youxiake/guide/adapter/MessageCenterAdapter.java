...
public class MessageCenterAdapter extends BaseQuickAdapter<HelloModel,BaseViewHolder> {

    public MessageCenterAdapter(@LayoutRes int layoutResId, @Nullable List<HelloModel> data) {

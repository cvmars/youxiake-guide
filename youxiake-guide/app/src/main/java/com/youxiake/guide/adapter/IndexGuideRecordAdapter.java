...
public class IndexGuideRecordAdapter extends BaseQuickAdapter<HelloModel,BaseViewHolder> {

    public IndexGuideRecordAdapter(@LayoutRes int layoutResId, @Nullable List<HelloModel> data) {
